...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/css/students.css" />
    <link rel="stylesheet" type="text/css" href="<?= base_url() ?>/assets/css/contact.css" />
    <!-- <link rel="stylesheet" type="text/css" href="assets/css/about.css" />
    
    <link rel="stylesheet" type="text/css" href="assets/css/employers.css" />
     -->
</head>
<body>
    <header>
    ...
    <nav class="navbar navbar-expand-lg navbar-light hbg shadow fixed-top">
        ...
        <a class="navbar-brand" href="home">
            <img src="<?= base_url() ?>/assets/images/logo-iaeste.png" width="70%" height="70%" alt="iaeste-ghana-logo">
        </a>
